...
`,
  ...
  C = {
    ...
    authDomain: `hours-tracker-505617.firebaseapp.com`,
    projectId: `hours-tracker-505617`,
    storageBucket: `hours-tracker-505617.firebasestorage.app`,
    messagingSenderId: `1053801277711`,
  ...
  te = [
    ...
    { name: `Notes`, icon: (0, x.jsx)(`img`, { src: `/assets/quick-notes-pencil.svg`, alt: `` }), className: `quick-add` },
  ...
  usesInitialContactWorkflow = (e, t) =>
    (e === `Client` && [`Initial Contact`, `MRO Question`].includes(t)) ||
    (e === `FA/Co-Worker` &&
  ...
  ie = (e, t = !1) => {
    let n = Math.floor(e / 60),
      ...
      i = n % 60;
    return t
      ? `${String(r).padStart(2, `0`)}:${String(i).padStart(2, `0`)}:${String(Math.max(0, e % 60)).padStart(2, `0`)}`
      : r
        ? `${r}h ${i}m`
        : `${i}m`;
  },
...
function ae() {
  let [e, t] = (0, b.useState)(null),
    ...
    [prescriptionFollowUp, setPrescriptionFollowUp] = (0, b.useState)([]),
    ...
    [supportNeedsOther, setSupportNeedsOther] = (0, b.useState)(``),
    ...
    [treatmentPlanOther, setTreatmentPlanOther] = (0, b.useState)(``),
    ...
    [dischargeFollowUpCareOther, setDischargeFollowUpCareOther] =
      (0, b.useState)(``),
    [dischargeDate, setDischargeDate] = (0, b.useState)(``),
    [clientDischargeShortcut, setClientDischargeShortcut] =
      (0, b.useState)(!1),
    ...
    [clientStageGroup, setClientStageGroup] = (0, b.useState)(`Getting started`),
    hotlineCaller = (0, b.useRef)(null),
    ...
    [historyEntryId, setHistoryEntryId] = (0, b.useState)(null),
    ...
    [dashboardEntryId, setDashboardEntryId] = (0, b.useState)(null),
    ...
    [quickNoteCase, setQuickNoteCase] = (0, b.useState)(``),
  ...
  ((0, b.useEffect)(() => {
    let e = !1,
      n = () => {
        if (!window.firebase) return !1;
        window.firebase.apps.length || window.firebase.initializeApp(C);
        let n = window.firebase.auth(),
          i = window.firebase.firestore();
        return (
          e || s({ auth: n, db: i }),
          n.onAuthStateChanged((n) => {
            e ||
              (t(
                n
                  ? {
    ...
    (0, b.useEffect)(() => {
      try {
        l(JSON.parse(localStorage.getItem(S) || `null`));
      } catch {}
    }, []),
    (0, b.useEffect)(() => {
      c
        ...
        .onSnapshot(
          (e) => {
            a(
              e.docs
                .map((e) => e.data())
                .sort((e, t) => t.startedAt.localeCompare(e.startedAt)),
            );
          },
          () => ue(`Cloud records could not be loaded.`),
        );
    }, [e, o]),
    (0, b.useEffect)(() => {
      if (!e || !ee.includes(e.email) || !o) {
        ...
        d(
          Math.max(
            ...
            (c.accumulatedSeconds || 0) +
              Math.floor((Date.now() - new Date(c.startedAt).getTime()) / 1e3),
          ),
        );
      e();
  ...
  let dashboardDrilldownMethod = dashboardCategory?.startsWith(`Contact: `)
      ...
      : null,
    dashboardDrilldownTitle = dashboardDrilldownMethod
      ? dashboardDrilldownMethod === `In-person`
        ? `In-person entries`
        : `${dashboardDrilldownMethod}s`
      : dashboardCategory,
    dashboardDrilldownEntries = dashboardCategory
      ? dashboardDrilldownMethod
        ? dashboardView.entries.filter(
            (e) => e.contactMethod === dashboardDrilldownMethod,
          )
        : dashboardView.categories.find((e) => e.name === dashboardCategory)
            ?.entries || []
      : [];
  ...
  let onCallScheduleCounts = {
    ...
    tomorrowCentralDate = addCalendarDays(
      centralDateKey(new Date(onCallNow)),
      1,
    ),
    upcomingTomorrowCount = onCallSchedules.filter(
      (e) =>
        getOnCallStatus(e, onCallNow) === `scheduled` &&
        e.startDate === tomorrowCentralDate,
    ).length,
    ...
    if (!e || !o) return !1;
    {
      ...
      try {
          ...
          similarRecentEntry =
            ...
            i.find((e) => {
              ...
              return (
                ...
                (e.detail || ``) === (t.detail || ``) &&
                (e.contactMethod || ``) === (t.contactMethod || ``) &&
                (e.salesforceCase || ``).trim().toLowerCase() ===
                  (t.salesforceCase || ``).trim().toLowerCase() &&
                Number.isFinite(timeDifference) &&
                timeDifference <= 15 * 60 * 1e3
              );
            });
        ...
        if (
          similarRecentEntry &&
          !window.confirm(
            `Possible duplicate: a similar ${activity} entry was logged within the last 15 minutes.\n\nSave this entry anyway?`,
          )
        )
          return !1;
        let entryId =
  ...
  function xe(e) {
    e === `Notes`
      ? (setQuickNoteText(``), setQuickNoteCase(``), h(`quickNote`))
      : ne[e]
  ...
  async function saveQuickNote() {
    ...
    try {
      ...
      await o.db
        ...
        .set({
          id,
          note: quickNoteText.trim().slice(0, 500),
          salesforceCase: quickNoteCase.trim().slice(0, 50),
          createdAt: new Date().toISOString(),
        });
      (setQuickNoteText(``), setQuickNoteCase(``), h(null));
    } catch {
      ue(`The note could not be saved. Please try again.`);
    } finally {
      ce(!1);
    }
  }
  ...
  function chooseDetail(e, t) {
    ...
    e === `Client` &&
    ![`Initial Contact`, `MRO Question`].includes(t)
      ? (setSelectedDetail(t),
    ...
    [`Base Leadership`, `CISM`, `Union`, `Professional Standards`].includes(t)
      ...
      : e === `Hotline` && t === `Client`
      ? (hotlineCaller.current = `Client`, setDetailParent(`Hotline`), _(`Client`), h(`detail`))
      : e === `Hotline` && t === `Treatment Center`
      ? (hotlineCaller.current = `Treatment Center`, setDetailParent(`Hotline`), _(`Treatment Center`), h(`detail`))
      ...
      : e === `Treatment Center` &&
          t === `Client Discharge Update / Call Request`
      ? (setSelectedDetail(`Client Discharge`),
        setSelectedTreatmentLevel(``),
        setDischargeDate(``),
        setClientDischargeShortcut(!1),
        h(`treatmentCenterDischarge`))
  ...
  function skipOptionalQuestionsToNotes() {
    const withOther = (items, other) => items.map((item) => item === `Other` && other.trim() ? `Other: ${other.trim()}` : item);
    let extra = {};
    if ([`positiveSubstances`, `substances`, `prescriptionFollowUp`, `treatmentPlanTypes`].includes(m)) {
      extra = {
        testPositive: selectedTestPositive,
        substances: selectedPositiveSubstances,
        supportNeeds: withOther(selectedSubstances, supportNeedsOther),
        ...(m === `prescriptionFollowUp` ? { prescriptionFollowUp } : {}),
        ...(m === `treatmentPlanTypes` ? {
          treatmentPlanAtThisTime: selectedTreatmentPlan,
          treatmentPlanTypes: withOther(selectedTreatmentPlanTypes, treatmentPlanOther),
        } : {}),
      };
    } else if (m === `ongoingRecovery`) {
      extra.ongoingRecoveryTypes = withOther(selectedOngoingRecoveryTypes, ongoingRecoveryOther);
    } else if ([`rspCompleted`, `rspRecovery`, `backOnlineCompleted`].includes(m)) {
      extra.completedTypes = selectedRSPCompletedTypes;
      if (m !== `backOnlineCompleted`) {
        extra.rspCompletedTypes = selectedRSPCompletedTypes;
        extra.rspStatus = selectedRSPStatus;
      }
      if (m === `rspRecovery`) extra.rspRecoveryTypes = withOther(selectedRSPRecoveryTypes, rspRecoveryOther);
    } else if (m === `dischargeFollowUpCare`) {
      extra.dischargeFollowUpCareTypes = withOther(selectedDischargeFollowUpCareTypes, dischargeFollowUpCareOther);
      extra.treatmentLevel = selectedTreatmentLevel;
      extra.dischargeDate = dischargeDate;
    }
  ...
  function continueWithoutOption() {
    ...
    if (m === `contactMethod` && usesInitialContactWorkflow(g, selectedDetail)) {
    ...
    const extra = m === `treatmentPlan` ? {
      treatmentPlanAtThisTime: ``,
      treatmentPlanTypes: [],
      ...(usesInitialContactWorkflow(g, selectedDetail) ? {
        testPositive: selectedTestPositive,
        substances: selectedPositiveSubstances,
        supportNeeds: selectedSubstances.map((value) => value === `Other` && supportNeedsOther.trim() ? `Other: ${supportNeedsOther.trim()}` : value),
      } : {}),
    } : [`treatmentCenter`, `iopTreatmentProgram`].includes(m) ? {
    ...
    (e === `Initial Contact`
        ...
        : e === `Initial Follow-up` || e === `Relapse`
          ...
          : e === `Client Discharge`
            ? (setSelectedTreatmentLevel(``),
              setDischargeDate(``),
              setClientDischargeShortcut(!0),
              _(`Treatment Center`),
              h(`treatmentCenterDischargeLevel`))
          : e === `RSP`
            ? (setSelectedRSPStatus(``),
              ...
              h(`rspStatus`))
          : e === `Back Online`
            ? (setSelectedRSPCompletedTypes([]), h(`backOnlineCompleted`))
    ...
    (setPendingTimer({
      ...
      setCategoryDate(
        stoppedTimerParts
          ...
          : e === `Client` && t?.startsWith(`In Treatment —`)
            ? ``
            : currentCentralInput().date,
      ),
      setCategoryHours(
  ...
  function editHistoryEntry(e) {
    ...
    (setEditingEntryId(e.id),
      ...
      setCategoryNote(e.comment || ``),
      setSalesforceCase(e.salesforceCase || ``),
      setDischargeDate(e.dischargeDate || ``),
  ...
  function saveCategorizedEntry(entry) {
    if (detailParent === `Hotline`) {
      const caller = hotlineCaller.current || entry.activity;
      entry = {
        ...entry,
        activity: `Hotline`,
        detail: [caller, entry.detail].filter(Boolean).join(` — `),
        contactMethod: `Call`,
      };
    }
    return be(entry);
  ...
  async function saveCategoryEntry() {
    ...
    let saved = await saveCategorizedEntry({
  ...
  function Le() {
    c && (l({ ...c, canceled: !0 }), d(0), y(null), h(null), oe(``));
  }
  function startDetailsLaterTimer() {
    (l({
      activity: `Timer`,
      detail: ``,
  ...
  function resumeTimer() {
    c &&
      !c.running &&
      l({ ...c, startedAt: new Date().toISOString(), running: !0 });
  }
  function requestTimerReset() {
    h(`resetTimerConfirm`);
  }
  function resetTimer() {
    (l(null), d(0), setShowStopwatch(!1), h(null), p(`timer`));
  }
  function returnToMainWithTimer() {
  ...
  function choosePostTimerDetail(e, t) {
    ...
    e === `Client` && t === `Back Online`
      ? (setSelectedDetail(t),
        setSelectedRSPCompletedTypes([]),
        y((n) => ({ ...n, activity: e, detail: t })),
        h(`backOnlineCompleted`))
      : e === `Client` && t === `Client Discharge`
      ? (setSelectedDetail(t),
        setSelectedTreatmentLevel(``),
        setDischargeDate(``),
        setClientDischargeShortcut(!0),
        ...
        y((n) => ({
          ...
          detail: `Client Discharge`,
        })),
        h(`postTreatmentCenterDischargeLevel`))
      : e === `Treatment Center` &&
          t === `Client Discharge Update / Call Request`
      ? (setSelectedDetail(`Client Discharge`),
        setSelectedTreatmentLevel(``),
        setDischargeDate(``),
        setClientDischargeShortcut(!1),
        h(`postTreatmentCenterDischarge`))
      : e === `Treatment Center` && t === `Client Issues`
                                    ...
                                    children: [
                                      (0, x.jsxs)(`div`, {
                                        children: [
                                          ...
                                          (0, x.jsx)(`span`, {
                                            className: `on-call-status ${getOnCallStatus(t, onCallNow)}${getOnCallStatus(t, onCallNow) === `scheduled` && t.startDate === tomorrowCentralDate ? ` upcoming-tomorrow` : ``}`,
              ...
              f === `timer`
                ? (0, x.jsxs)(x.Fragment, {
                    children: [
                            ...
                            children: [
                              ...
                              (0, x.jsxs)(`p`, {
                                ...
                                children:
                                  ...
                                  : `Timer stopped — start again to keep adding time`,
                              }),
                              c.detail &&
                                (0, x.jsx)(`p`, {
                                  className: `running-detail`,
                                  children: c.detail,
                                }),
                              c.contactMethod &&
                                usesContactMethod(c.activity, c.detail) &&
                                (0, x.jsx)(`p`, {
                                  className: `running-detail`,
                                  children: c.contactMethod,
                                }),
                              (0, x.jsx)(`div`, {
                                className: `timer`,
                                children: ie(u, !0),
                              ...
                              (0, x.jsx)(`div`, {
                                ...
                                children: te.map((e) =>
                                  (0, x.jsxs)(
                                    `button`,
                                    {
                                      className: `activity-button ${e.className}`,
                                      onClick: () => xe(e.name),
                                      children: [
                                        (0, x.jsx)(`span`, {
                      ...
                      !showStopwatch && quickNotes.length > 0 &&
                        (0, x.jsxs)(`section`, {
                          className: `quick-notes-section`,
                          children: [
                            (0, x.jsxs)(`div`, {
                              className: `quick-notes-heading`,
                              children: [
                                (0, x.jsx)(`h3`, {
                                  children: `Unfinished notes`,
                                }),
                                (0, x.jsx)(`span`, {
                                  children: quickNotes.length,
                                }),
                              ],
                            }),
                            (0, x.jsx)(`div`, {
                              className: `quick-note-list`,
                              children: quickNotes.map((t) =>
                                (0, x.jsxs)(
                                  `article`,
                                  {
                                    ...
                                    children: [
                                      (0, x.jsxs)(`div`, {
                                        children: [
                                          ...
                                          t.salesforceCase &&
                                            (0, x.jsx)(`small`, {
                                              children: `Salesforce #${t.salesforceCase}`,
                                            }),
                                        ],
                                      }),
                                      (0, x.jsx)(`button`, {
                          ...
                          children: [
                            (0, x.jsxs)(`div`, {
                              ...
                              children: [
                                ...
                                (0, x.jsxs)(`button`, {
                                  className: `manual-button manual-entry-button`,
                                  onClick: () => {
                                    (oe(``), h(`manual`));
                                  },
                                  children: [
                        ...
                        dashboardCategory
                          ? (0, x.jsxs)(`div`, {
                              ...
                              children: [
                                ...
                                dashboardDrilldownEntries.length
                                  ? (0, x.jsx)(`div`, {
                                      className: `dashboard-detail-list`,
                                      children: dashboardDrilldownEntries.map((e) =>
                                          (0, x.jsxs)(
                                            `article`,
                                            {
                                              className:
                                                dashboardEntryId === e.id
                                                  ? `expanded`
                                                  : ``,
                                              onClick: () =>
                                                setDashboardEntryId((t) =>
                                                  t === e.id ? null : e.id,
                                                ),
                                              children: [
                                                (0, x.jsxs)(`div`, {
                                                  className: `dashboard-entry-summary`,
                                                  children: [
                                                    (0, x.jsx)(`strong`, {
                                                ...
                                                (0, x.jsx)(`strong`, {
                                                  className: `dashboard-entry-duration`,
                                                  children: ie(e.duration),
                                                }),
                                                dashboardEntryId === e.id &&
                                                  (0, x.jsxs)(`div`, {
                                                    className: `dashboard-entry-details`,
                                                    children: [
                                                      (0, x.jsxs)(`p`, {
                                                        children: [
                                                      ...
                                                      (0, x.jsxs)(`p`, {
                                                        children: [
                                                          (0, x.jsx)(`b`, { children: `Subcategory` }),
                                                          (0, x.jsx)(`span`, { children: e.detail || `—` }),
                                                        ],
                                                      }),
                                                      e.contactMethod &&
                                                        (0, x.jsxs)(`p`, {
                                                          children: [
                                                            (0, x.jsx)(`b`, { children: `Contact method` }),
                                                            (0, x.jsx)(`span`, { children: e.contactMethod }),
                                                          ],
                                                        }),
                                                      e.salesforceCase &&
                                                        (0, x.jsxs)(`p`, {
                                                          children: [
                                                            (0, x.jsx)(`b`, { children: `Case number` }),
                                                            (0, x.jsx)(`span`, { children: e.salesforceCase }),
                                                          ],
                                                        }),
                                                      e.dischargeDate &&
                                                        (0, x.jsxs)(`p`, {
                                                          children: [
                                                            (0, x.jsx)(`b`, { children: `Discharge date` }),
                                                            (0, x.jsx)(`span`, { children: e.dischargeDate }),
                                                          ],
                                                        }),
                                                      e.testPositive &&
                                                        (0, x.jsxs)(`p`, {
                                                          children: [
                                                            (0, x.jsx)(`b`, { children: `Test positive` }),
                                                            (0, x.jsx)(`span`, { children: e.testPositive }),
                                                          ],
                                                        }),
                                                      (e.positiveSubstances || e.substances)?.length > 0 &&
                                                        (0, x.jsxs)(`p`, {
                                                          children: [
                                                            (0, x.jsx)(`b`, { children: `Substance type` }),
                                                            (0, x.jsx)(`span`, {
                                                              children: (e.positiveSubstances || e.substances).join(`, `),
                                                            }),
                                                          ],
                                                        }),
                                                      e.comment &&
                                                        (0, x.jsxs)(`p`, {
                                                          className: `dashboard-entry-notes`,
                                                          children: [
                                                            (0, x.jsx)(`b`, { children: `Notes` }),
                                                            (0, x.jsx)(`span`, { children: e.comment }),
                                                          ],
                                                        }),
                                                    ],
                                                  }),
                                  ...
                                  : (0, x.jsx)(`p`, {
                                      ...
                                      children: `No matching entries for the selected period.`,
                                    }),
                              ],
                            })
                          : (0, x.jsxs)(x.Fragment, {
                              children: [
                                (0, x.jsxs)(`div`, {
                                  ...
                                  children: [
                                    ...
                                    ...[
                                      [`Calls`, dashboardView.contactCounts.Call, `Call`],
                                      [`Texts`, dashboardView.contactCounts.Text, `Text`],
                                      [`Emails`, dashboardView.contactCounts.Email, `Email`],
                                      [`In-person`, dashboardView.contactCounts[`In-person`], `In-person`],
                                    ].map(([e, t, n]) =>
                                      (0, x.jsxs)(
                                        `button`,
                                        {
                        ...
                        ? (0, x.jsx)(`div`, {
                            ...
                            children: historyView.entries.map((t) =>
                              (0, x.jsxs)(
                                `article`,
                                {
                                  className: `entry ${swipedEntryId === t.id ? `swiped` : ``}${historyEntryId === t.id ? ` expanded` : ``}`,
                                  onClick: () =>
                                    setHistoryEntryId((e) =>
                                      e === t.id ? null : t.id,
                                    ),
                                  ...
                                  children: [
                                        ...
                                        (0, x.jsxs)(`div`, {
                                          children: [
                                            ...
                                            t.contactMethod &&
                                              ...
                                              (0, x.jsx)(`span`, {
                                                className: `detail-pill`,
                                                children: t.contactMethod,
                                              }),
                                            t.testPositive &&
                                              (0, x.jsx)(`span`, {
                                                className: `detail-pill`,
                                                children: `Test positive: ${t.testPositive}`,
                                              }),
                                            t.substances?.length > 0 &&
                                              (0, x.jsx)(`span`, {
                                                className: `detail-pill`,
                                                children: t.substances.join(` + `),
                                              }),
                                            t.comment &&
                                              (0, x.jsx)(`span`, {
                                    ...
                                    historyEntryId === t.id &&
                                      (0, x.jsxs)(`div`, {
                                        className: `dashboard-entry-details history-entry-details`,
                                        children: [
                                          (0, x.jsxs)(`p`, {
                                            children: [
                                              (0, x.jsx)(`b`, { children: `Date of Contact` }),
                                              (0, x.jsx)(`span`, {
                                                children: new Date(t.startedAt).toLocaleString([], {
                                                  month: `short`,
                                                  day: `numeric`,
                                                  year: `numeric`,
                                                  hour: `numeric`,
                                          ...
                                          (0, x.jsxs)(`p`, {
                                            children: [
                                              (0, x.jsx)(`b`, { children: `Subcategory` }),
                                              (0, x.jsx)(`span`, { children: t.detail || `—` }),
                                            ],
                                          }),
                                          t.contactMethod &&
                                            (0, x.jsxs)(`p`, {
                                              children: [
                                                (0, x.jsx)(`b`, { children: `Contact method` }),
                                                (0, x.jsx)(`span`, { children: t.contactMethod }),
                                              ],
                                            }),
                                          t.salesforceCase &&
                                            (0, x.jsxs)(`p`, {
                                              children: [
                                                (0, x.jsx)(`b`, { children: `Case number` }),
                                                (0, x.jsx)(`span`, { children: t.salesforceCase }),
                                              ],
                                            }),
                                          (t.treatmentCenter || t.iopProgram) &&
                                            (0, x.jsxs)(`p`, {
                                              children: [
                                                (0, x.jsx)(`b`, { children: `Treatment program` }),
                                                (0, x.jsx)(`span`, { children: t.treatmentCenter || t.iopProgram }),
                                              ],
                                            }),
                                          t.dischargeDate &&
                                            (0, x.jsxs)(`p`, {
                                              children: [
                                                (0, x.jsx)(`b`, { children: `Discharge date` }),
                                                (0, x.jsx)(`span`, { children: t.dischargeDate }),
                                              ],
                                            }),
                                          t.testPositive &&
                                            (0, x.jsxs)(`p`, {
                                              children: [
                                                (0, x.jsx)(`b`, { children: `Test positive` }),
                                                (0, x.jsx)(`span`, { children: t.testPositive }),
                                              ],
                                            }),
                                          (t.positiveSubstances || t.substances)?.length > 0 &&
                                            (0, x.jsxs)(`p`, {
                                              children: [
                                                (0, x.jsx)(`b`, { children: `Substance type` }),
                                                (0, x.jsx)(`span`, {
                                                  children: (t.positiveSubstances || t.substances).join(`, `),
                                                }),
                                              ],
                                            }),
                                          t.comment &&
                                            (0, x.jsxs)(`p`, {
                                              ...
                                              children: [
                                                (0, x.jsx)(`b`, { children: `Notes` }),
                                                (0, x.jsx)(`span`, { children: t.comment }),
                                              ],
                                            }),
                                        ],
                                      }),
              ...
              m &&
                (0, x.jsx)(`div`, {
                  ...
                  children: (0, x.jsxs)(`section`, {
                    className: `modal${m === `categoryEntry` ? ` final-entry-modal` : ``}${[`categoryEntry`, `comment`, `manual`].includes(m) ? ` amber-entry-modal` : ``}`,
                    role: `dialog`,
                    "aria-modal": `true`,
                    children: [
                      m !== `resetTimerConfirm` &&
                        ...
                        children:
                          m === `detail`
                            ...
                            : m === `hotlineSubcategoryOther`
                              ? hotlineOtherParent
                            : m === `treatmentCenterDischargeLevel` ||
                                m === `postTreatmentCenterDischargeLevel` ||
                        ...
                        children:
                          m === `detail`
                            ...
                            : m === `rspStatus`
                              ? `RSP Status`
                            : m === `rspCompleted`
                              ? `Completed? Select all that apply (optional)`
                            : m === `backOnlineCompleted`
                              ? `Completed? Select all that apply (optional)`
                            : m === `rspRecovery`
                              ? `What type of ongoing recovery?`
                          ...
                          children: [
                            ...
                            children: [
                              (0, x.jsxs)(`button`, {
                                ...
                                "aria-expanded": clientStageGroup === group,
                                "aria-controls": `client-stage-panel-${index}`,
                                onClick: () => setClientStageGroup(clientStageGroup === group ? null : group),
                                children: [group, (0, x.jsx)(`span`, { "aria-hidden": true, children: clientStageGroup === group ? `▾` : `▸` })],
                              }),
                              (0, x.jsx)(`div`, {
                                id: `client-stage-panel-${index}`,
                                hidden: clientStageGroup !== group,
                      ...
                      m === `otherDetail` &&
                        ...
                        (0, x.jsxs)(x.Fragment, {
                          children: [
                            ...
                            (0, x.jsx)(`button`, {
                              className: `save-button step-navigation-button`,
                      ...
                      m === `committeeWork` &&
                        (0, x.jsx)(`div`, {
                          className: `detail-options`,
                          children: committeeWorkTypes.map((e) =>
                            (0, x.jsxs)(
                              `button`,
                              {
                                onClick: () => {
                        ...
                        (0, x.jsxs)(x.Fragment, {
                          children: [
                            ...
                            (0, x.jsx)(`input`, {
                              ...
                              value: otherDetailText,
                              onChange: (e) => setOtherDetailText(e.target.value),
                              placeholder: `Enter the committee work type`,
                              autoFocus: !0,
                            }),
                            (0, x.jsx)(`button`, {
                              className: `save-button step-navigation-button`,
                              disabled: !otherDetailText.trim(),
                              onClick: () => {
                                let detail = `Committee Work — Other — ${otherDetailText.trim()}`;
                                v
                                  ? (y((e) => ({
                                      ...e,
                                      activity: `Other Team Work`,
                      ...
                      m === `contactMethod` &&
                        ...
                        (0, x.jsx)(`div`, {
                          className: `detail-options`,
                          children: contactMethodsFor(g).map((e) =>
                            (0, x.jsxs)(
                              `button`,
                              {
                                onClick: () =>
                        ...
                        (0, x.jsxs)(x.Fragment, {
                          children: [
                            ...
                            (0, x.jsx)(`datalist`, {
                              ...
                              children: Array.from(
                                i.reduce((e, t) => {
                                  let n = t.salesforceCase?.trim();
                                  return n && !e.has(n) && e.set(n, t), e;
                                }, new Map()).values(),
                              )
                                .slice(0, 12)
                                .map((e) => {
                                  let t = e.salesforceCase.trim(),
                                    n = e.date || `Recent entry`,
                                    i = e.detail || e.activity || `Client entry`;
                                  return (0, x.jsx)(
                                    `option`,
                                    { value: t, label: `${n} · ${i}` },
                                    t,
                      ...
                      m === `hotlineFlightAttendant` &&
                        ...
                        (0, x.jsx)(`div`, {
                          className: `detail-options`,
                          children: hotlineFlightAttendantTypes.map((e) =>
                            (0, x.jsxs)(
                              `button`,
                              {
                                onClick: () =>
                            ...
                            (0, x.jsxs)(
                              `button`,
                              {
                                onClick: () => {
                                  ...
                                  e === `IOP` || clientDischargeShortcut
                                    ? (setSelectedDetail(
                                        `Client Discharge — ${e} — Discharge Call`,
                                      ),
                            ...
                            (0, x.jsxs)(
                              `button`,
                              {
                                onClick: () => {
                                  setSelectedDetail(
                                    selectedTreatmentLevel
                                      ? `Client Discharge — ${selectedTreatmentLevel} — ${e}`
                                      : `Client Discharge — ${e}`,
                                  );
                                  e === `Discharge Call`
                                    ? (setSelectedDischargeFollowUpCareTypes([]),
                        ...
                        (0, x.jsxs)(x.Fragment, {
                          children: [
                            (0, x.jsx)(`p`, {
                              ...
                              children: `Select all that apply (optional)`,
                            }),
                            (0, x.jsx)(`div`, {
                              ...
                              children: [
                                ...
                                (0, x.jsxs)(`label`, { className: `prescription-option multi-select-option`, children: [(0, x.jsx)(`input`, { type: `checkbox`, checked: selectedDischargeFollowUpCareTypes.includes(e), onChange: () => setSelectedDischargeFollowUpCareTypes((items) => items.includes(e) ? items.filter((item) => item !== e) : [...items, e]) }), (0, x.jsx)(`span`, { children: e })] }, e),
                              ),
                            }),
                            ...
                            (0, x.jsx)(`button`, {
                              ...
                              onClick: () => {
                                let careTypes =
                                  ...
                                  careSummary = careTypes.length
                                    ? careTypes.join(` + `)
                                    : `Not selected`,
                                  detail = selectedTreatmentLevel
                                    ? `Client Discharge — ${selectedTreatmentLevel} — Discharge Call — Follow-up Care: ${careSummary}`
                                    : `Client Discharge — Discharge Call — Follow-up Care: ${careSummary}`;
                                v
                                  ? (y((e) => ({
                                      ...e,
                                      activity: `Treatment Center`,
                            ...
                            (0, x.jsx)(`button`, {
                              type: `button`,
                              className: `save-button option-skip-button step-navigation-button`,
                              onClick: skipOptionalQuestionsToNotes,
                              children: `Skip to notes`,
                            }),
                          ],
                        }),
                      m === `treatmentCenterClientIssues` &&
                        ...
                        (0, x.jsxs)(x.Fragment, {
                          children: [
                            ...
                            (0, x.jsx)(`button`, {
                              className: `save-button step-navigation-button`,
                              onClick: () =>
                                selectedPositiveSubstances.length === 1 &&
                                selectedPositiveSubstances[0] === `Prescription Medication`
                                  ? (setPrescriptionFollowUp([]), h(`prescriptionFollowUp`))
                                  ...
                                  : (setSelectedTreatmentPlan(``),
                                    ...
                                    setTreatmentPlanOther(``),
                                    h(`treatmentPlan`)),
                              children: selectedPositiveSubstances.length === 1 &&
                                selectedPositiveSubstances[0] === `Prescription Medication`
                                  ? `Next`
                                  : `Next`,
                            }),
                      ...
                      m === `prescriptionFollowUp` &&
                        (0, x.jsxs)(x.Fragment, {
                          children: [
                            (0, x.jsx)(`p`, { children: `Check all that apply` }),
                            ...[`MRO Called`, `They have a current prescription`, `They do NOT have a current prescription`].map((option) =>
                              (0, x.jsxs)(`label`, {
                                className: `prescription-option`,
                                children: [
                                  (0, x.jsx)(`input`, {
                                    type: `checkbox`,
                                    checked: prescriptionFollowUp.includes(option),
                                    onChange: () => setPrescriptionFollowUp((current) => current.includes(option) ? current.filter((item) => item !== option) : [...current, option]),
                                  }),
                                  option,
                                ],
                              }, option)),
                            (0, x.jsx)(`button`, {
                              className: `save-button step-navigation-button`,
                              children: `Next`,
                              onClick: () => Se(g, selectedDetail, detailParent === `Hotline` ? `Call` : initialContactMethod || `Call`, {
                                testPositive: selectedTestPositive,
                                substances: selectedPositiveSubstances,
                          ...
                          children: [
                            (0, x.jsx)(`div`, {
                              ...
                              children: [
                                ...
                                (0, x.jsxs)(`label`, { className: `prescription-option multi-select-option`, children: [(0, x.jsx)(`input`, { type: `checkbox`, checked: selectedSubstances.includes(e), onChange: () => setSelectedSubstances((items) => items.includes(e) ? items.filter((item) => item !== e) : [...items, e]) }), (0, x.jsx)(`span`, { children: e })] }, e),
                              ),
                            }),
                            selectedSubstances.includes(`Other`) &&
                              (0, x.jsx)(`input`, {
                                className: `comment-input`,
                                value: supportNeedsOther,
                                onChange: (e) =>
                                  setSupportNeedsOther(e.target.value),
                                placeholder: `Enter other support need`,
                              }),
                            (0, x.jsx)(`button`, {
                              className: `save-button step-navigation-button`,
                              disabled:
                                selectedSubstances.includes(`Other`) &&
                                !supportNeedsOther.trim(),
                              onClick: () =>
                                selectedTestPositive === `No` &&
                                selectedSubstances.includes(`Substance Abuse`)
                                              ...
                                              : void 0,
                                          {
                                            ...
                                            selectedDetail,
                                              ...
                                              ? {
                                                  ...
                                                  supportNeeds:
                                                    selectedSubstances.map((e) =>
                                                      e === `Other`
                                                        ? `Other: ${supportNeedsOther.trim()}`
                                                        : e,
                                                    ),
                                                }
                                              : {}),
                          ...
                          children: [
                            (0, x.jsx)(`div`, {
                              ...
                              children: [
                                ...
                                (0, x.jsxs)(`label`, { className: `prescription-option multi-select-option`, children: [(0, x.jsx)(`input`, { type: `checkbox`, checked: selectedTreatmentPlanTypes.includes(e), onChange: () => setSelectedTreatmentPlanTypes((items) => items.includes(e) ? items.filter((item) => item !== e) : [...items, e]) }), (0, x.jsx)(`span`, { children: e })] }, e),
                              ),
                            }),
                            selectedTreatmentPlanTypes.includes(`Other`) &&
                              (0, x.jsx)(`input`, {
                                className: `comment-input`,
                                value: treatmentPlanOther,
                                onChange: (e) =>
                                  setTreatmentPlanOther(e.target.value),
                                placeholder: `Enter other treatment plan`,
                              }),
                            (0, x.jsx)(`button`, {
                              className: `save-button step-navigation-button`,
                              disabled:
                                selectedTreatmentPlanTypes.includes(`Other`) &&
                                !treatmentPlanOther.trim(),
                              onClick: () =>
                                Se(
                                  g,
                                  selectedDetail,
                                      ...
                                      : void 0,
                                  {
                                    treatmentPlanAtThisTime: selectedTreatmentPlan,
                                    treatmentPlanTypes:
                                      selectedTreatmentPlanTypes.map((e) =>
                                        e === `Other`
                                          ? `Other: ${treatmentPlanOther.trim()}`
                                          : e,
                                      ),
                                    ...(usesInitialContactWorkflow(
                                    g,
                                    selectedDetail,
                                      ...
                                      ? {
                                          ...
                                          substances:
                                            selectedPositiveSubstances,
                                          supportNeeds: selectedSubstances.map((e) =>
                                            e === `Other`
                                              ? `Other: ${supportNeedsOther.trim()}`
                                              : e,
                                          ),
                          ...
                          children: [
                            ...
                            (0, x.jsx)(`div`, {
                              ...
                              children: [
                                ...
                                (0, x.jsxs)(`label`, { className: `prescription-option multi-select-option`, children: [(0, x.jsx)(`input`, { type: `checkbox`, checked: selectedOngoingRecoveryTypes.includes(e), onChange: () => setSelectedOngoingRecoveryTypes((items) => items.includes(e) ? items.filter((item) => item !== e) : [...items, e]) }), (0, x.jsx)(`span`, { children: e })] }, e),
                              ),
                            }),
                            ...
                            (0, x.jsx)(`button`, {
                              ...
                              onClick: () => {
                                ...
                                let detail = `Ongoing Recovery — ${
                                  recoveryTypes.length
                                    ? recoveryTypes.join(` + `)
                                    : `Not selected`
                                }`;
                          ...
                          children: [
                            (0, x.jsx)(`div`, {
                              ...
                              children: [`Inpatient`, `IOP`, `SAP`].map((e) =>
                                (0, x.jsxs)(`label`, { className: `prescription-option multi-select-option`, children: [(0, x.jsx)(`input`, { type: `checkbox`, checked: selectedRSPCompletedTypes.includes(e), onChange: () => setSelectedRSPCompletedTypes((items) => items.includes(e) ? items.filter((item) => item !== e) : [...items, e]) }), (0, x.jsx)(`span`, { children: e })] }, e),
                              ),
                            }),
                            (0, x.jsx)(`button`, {
                              className: `save-button step-navigation-button`,
                      ...
                      m === `backOnlineCompleted` &&
                        ...
                        (0, x.jsxs)(x.Fragment, {
                          children: [
                            ...
                            (0, x.jsx)(`div`, {
                              className: `quick-comments`,
                              children: [`Inpatient`, `IOP`, `RSP`].map((e) =>
                                (0, x.jsxs)(`label`, { className: `prescription-option multi-select-option`, children: [(0, x.jsx)(`input`, { type: `checkbox`, checked: selectedRSPCompletedTypes.includes(e), onChange: () => setSelectedRSPCompletedTypes((items) => items.includes(e) ? items.filter((item) => item !== e) : [...items, e]) }), (0, x.jsx)(`span`, { children: e })] }, e),
                              ),
                            }),
                            (0, x.jsx)(`button`, {
                              className: `save-button step-navigation-button`,
                              onClick: () => {
                                let detail = `Back Online — Completed: ${
                                  selectedRSPCompletedTypes.length
                                    ? selectedRSPCompletedTypes.join(` + `)
                                    : `Not selected`
                                }`;
                                v
                                  ? (y((e) => ({
                                      ...
                                      activity: `Client`,
                                      detail,
                                      completedTypes: selectedRSPCompletedTypes,
                                    })),
                                    h(`comment`))
                                  : (setSelectedDetail(detail), h(`contactMethod`));
                              },
                              children: `Next`,
                            }),
                            (0, x.jsx)(`button`, {
                          ...
                          children: [
                            ...
                            (0, x.jsx)(`div`, {
                              ...
                              children: [
                                ...
                                (0, x.jsxs)(`label`, { className: `prescription-option multi-select-option`, children: [(0, x.jsx)(`input`, { type: `checkbox`, checked: selectedRSPRecoveryTypes.includes(e), onChange: () => setSelectedRSPRecoveryTypes((items) => items.includes(e) ? items.filter((item) => item !== e) : [...items, e]) }), (0, x.jsx)(`span`, { children: e })] }, e),
                              ),
                            }),
                            ...
                            (0, x.jsx)(`button`, {
                              ...
                              onClick: () => {
                                ...
                                Se(
                                  g,
                                  `RSP — ${selectedRSPStatus} — Completed: ${
                                    selectedRSPCompletedTypes.length
                                      ? selectedRSPCompletedTypes.join(` + `)
                                      : `Not selected`
                                  } — Ongoing Recovery: ${
                      ...
                      m === `categoryEntry` &&
                        ...
                        (0, x.jsxs)(x.Fragment, {
                          children: [
                            ...
                            (0, x.jsx)(`input`, {
                              className: `comment-input date-contact-input`,
                              type: `date`,
                              value: categoryDate,
                            ...
                            pendingTimer.activity === `Treatment Center` &&
                              ...
                              (0, x.jsxs)(x.Fragment, {
                                children: [
                                  (0, x.jsx)(`label`, {
                                    className: `field-label`,
                                    children: `Discharge date (optional)`,
                                  }),
                                  (0, x.jsx)(`input`, {
                                    className: `comment-input`,
                                    type: `date`,
                                ...
                                onClick: () => {
                                  ...
                                  e === `IOP` || clientDischargeShortcut
                                    ? (y((t) => ({
                                        ...t,
                                        activity: `Treatment Center`,
                                        detail: `Client Discharge — ${e} — Discharge Call`,
                                        treatmentLevel: e,
                                      })),
                                      setSelectedDischargeFollowUpCareTypes([]),
                                      setDischargeFollowUpCareOther(``),
                      ...
                      m === `resetTimerConfirm` &&
                        (0, x.jsxs)(`div`, {
                          ...
                          children: [
                            (0, x.jsx)(`p`, {
                              children: `This will erase the accumulated time and return to the main page.`,
                            }),
                            (0, x.jsx)(`button`, {
                              className: `reset-confirm-button`,
                              onClick: resetTimer,
                              children: `Yes, reset timer`,
                            }),
                            (0, x.jsx)(`button`, {
                              className: `keep-timer-button`,
                              onClick: () => h(null),
                              children: `No, keep timer`,
                            }),
                          ],
                        }),
                      m === `quickNote` &&
                        (0, x.jsxs)(x.Fragment, {
                          children: [
                            ...
                            (0, x.jsx)(`input`, {
                              ...
                              maxLength: 50,
                              value: quickNoteCase,
                              onChange: (e) => setQuickNoteCase(e.target.value),
                              placeholder: `Optional`,
                            }),
                            (0, x.jsx)(`p`, {
                              className: `safe-reminder`,
                              children: `This draft stays out of Google Sheets until you finish it.`,
                            }),
                            (0, x.jsx)(`button`, {
                              className: `save-button`,
                              disabled: se || !quickNoteText.trim(),
                              onClick: saveQuickNote,
                              children: se ? `Saving…` : `Save for later`,
                            }),
                          ],
                        }),
                      m === `finishQuickNoteCategory` &&
                      ...
                      m === `manual` &&
                            ...
                            usesContactMethod(T, de) &&
                              (0, x.jsxs)(x.Fragment, {
                                children: [
                                  ...
                                  (0, x.jsx)(`div`, {
                                    className: `quick-comments`,
                                    children: contactMethodsFor(T).map((e) =>
                                      (0, x.jsx)(
                                        `button`,
                                        {
                                          className:
                                      ...
                                      children: [
                                        ...
                                        (0, x.jsx)(`div`, {
                                          ...
                                          children: [
                                            ...
                                            (0, x.jsxs)(`label`, { className: `prescription-option multi-select-option`, children: [(0, x.jsx)(`input`, { type: `checkbox`, checked: manualPositiveSubstances.includes(e), onChange: () => setManualPositiveSubstances((items) => items.includes(e) ? items.filter((item) => item !== e) : [...items, e]) }), (0, x.jsx)(`span`, { children: e })] }, e),
                                          ),
                                        }),
                                      ],
                                    }),
                                        ...
                                        (0, x.jsx)(`div`, {
                                          ...
                                          children: [
                                            ...
                                            `Sex Addiction`,
                                              ...
                                              (0, x.jsxs)(`label`, { className: `prescription-option multi-select-option`, children: [(0, x.jsx)(`input`, { type: `checkbox`, checked: manualSubstances.includes(e), onChange: () => setManualSubstances((items) => items.includes(e) ? items.filter((item) => item !== e) : [...items, e]) }), (0, x.jsx)(`span`, { children: e })] }, e),
                                          ),
                                        }),
                                      ],
                                    }),
                        ...
                        [`detail`, `contactMethod`, `testPositive`, `treatmentPlan`,
                        `treatmentLevel`, `treatmentCenter`, `iopTreatmentProgram`,
                        `rspStatus`, `reachOutRequestType`, `hotlineFlightAttendant`,
                        `hotlineCallerReason`, `treatmentCenterClientIssues`,
                        `treatmentCenterDischargeLevel`, `committeeWork`].includes(m) && g &&
                        (0, x.jsx)(`button`, {
                          className: (m === `testPositive` || (m === `contactMethod` && usesInitialContactWorkflow(g, selectedDetail))) ? `save-button step-navigation-button` : `save-button option-skip-button step-navigation-button`,
                          onClick: continueWithoutOption,
                          children: m === `testPositive` || (m === `contactMethod` && usesInitialContactWorkflow(g, selectedDetail)) ? `Next` : `Skip to notes`,
                        }),
                      m === `testPositive` &&
                        (0, x.jsx)(`button`, {
                          type: `button`,
                      ...
                      (m === `comment` || m === `manual`) &&
                        (0, x.jsxs)(x.Fragment, {
                          children: [
                            ...
                            (0, x.jsx)(`p`, {
                              className: `safe-reminder`,
                              children: `Case numbers are allowed. Please don’t enter names or phone numbers.`,
                            }),
                            (0, x.jsx)(`button`, {
                              className: `save-button`,
                              disabled:
